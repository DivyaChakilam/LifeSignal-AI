...
const emergencyContactsSchema = z.object({
  ...
  contact2_phone: z.string().regex(/^\+?[1-9]\d{6,14}$/, { message: "Invalid phone number format." }).optional().or(z.literal("")),
}).refine(v => {
...
// ✅ EMPTY defaults (no placeholders saved or shown)
  ...
  return (
    <Card className="shadow-lg">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Contact 2 only if any field exists */}
        {(hasContact2) && (
